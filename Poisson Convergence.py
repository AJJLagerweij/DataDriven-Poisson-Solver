...
if __name__ == "__main__":
    ...
    num = 41
    rotation_domain1 = np.linspace(-3, -10, num=num)
    rotation_domain2 = np.linspace(3.3, 12.6, num=num)
    ...
    # Cost J^Omega_0
    costH0Omega_surface = axs[0, 0].contourf(rot1_grid, rot2_grid, costJ0Omega)
    ...
    # Cost J^Omega_1
    costH1Omega_surface = axs[0, 1].contourf(rot1_grid, rot2_grid, costJ1Omega)
    ...
    # Cost J^Gamma_0
    costH0Gamma_surface = axs[0, 2].contourf(rot1_grid, rot2_grid, costJ0Gamma)
    ...
    # Cost J^Gamma_1
    costH1Gamma_surface = axs[1, 0].contourf(rot1_grid, rot2_grid, costJ1Gamma)
    ...
    costH1Omega_w_surface = axs[1, 1].contourf(rot1_grid, rot2_grid, costJ1Omega_w)
    ...
    # Error surface.
    error_surface = axs[1, 2].contourf(rot1_grid, rot2_grid, error)
